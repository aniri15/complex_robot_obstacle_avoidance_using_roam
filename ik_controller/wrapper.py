...
lib = ctypes.CDLL('./ik_controller/build/libsolve_ik.so')
...
def solve_ik(q, obstacles, target_pos, options):
    # Convert data to ctypes
    q_arr = (ctypes.c_float * 7)(*q)
    obstacles_arr = (Obstacle * 3)(*[
    ...
    lib.solve_ik(q_arr, obstacles_arr, target_pos_arr, ctypes.byref(options_ctypes), q_res, ctypes.byref(f_res))
