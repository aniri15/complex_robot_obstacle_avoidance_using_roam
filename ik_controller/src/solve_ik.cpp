...
extern "C" {
    ...
    void solve_ik(const float q[7], const Obstacle obstacles[3], const float target_pos[3], const Options* options, float q_res[7], float* f_res) {
        generate_duration = 0;
        evaluate_duration = 0;
        update_duration = 0;
        sort_duration = 0;
